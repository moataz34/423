 ...
 *****************************************************************************/
#define SPI_ACCEL_CONTROL_REG_OFFSET    0x00  // Control register
#define SPI_ACCEL_TX_COUNT_REG_OFFSET   0x04  // TX count register
#define SPI_ACCEL_TX_DATA_REG_OFFSET    0x08  // TX data register
#define SPI_ACCEL_STATUS_REG_OFFSET     0x0C  // Status register
#define SPI_ACCEL_RX_COUNT_REG_OFFSET   0x10  // RX count register
#define SPI_ACCEL_RX_DATA_REG_OFFSET    0x14  // RX data register
